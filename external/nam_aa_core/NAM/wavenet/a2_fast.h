...
/// \brief Build an A2 fast-path DSP directly with an oversampling factor.
/// \param channels 3 (A2 nano) or 8 (A2 standard), from is_a2_shape().
/// \param weights The full weight stream from the .nam file.
/// \param sampleRate Expected (native) sample rate of the model.
/// \param oversampling 1 = native; 2 = dilations and head spacing scaled by 2.
/// \return DSP instance. Call prewarm() before use.
